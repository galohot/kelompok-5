      ...
      <div class="container container-tight py-4">
        <div class="text-center mb-4">
          <a href="." class="navbar-brand">
            <img src="{{ asset('./static/LogoKemlu.png') }}" width="110" height="32" alt="Tabler" class="navbar-brand-image-login">
          </a>
        </div>
          ...
          <div class="card-body">
            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="mb-3">
                ...
                <input id="email" type=text" class="form-control" placeholder="your@email.com" name="login" :value="old('login')" required autofocus autocomplete="username">
              </div>
              <div class="mb-2">
