...
<div class="container">
    <div class="col">
        <div class="input-group mb-3">
            ...
            <select class="custom-select form-control-sm col-sm-10" id="countryDropdown">
                @foreach ($countries as $country)
                    <option value="{{ $country->CountryCode }}" {{ $countryCode == $country->CountryCode ? 'selected' : '' }}>
                        {{ $country->Country }}
                    </option>
                @endforeach
            </select>
...
<div class="text-center">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Comparison Between Current Price and Constant Price (Real)</h5>
...
<div class="container my-4">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        @else
          <table id="gdpDataTable" class="table table-hover">
            <thead>
              <tr>
                <th>Year</th>
                <th>Series</th>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        @else
          <table id="educationDataTable" class="table table-hover">
            <thead>
              <tr>
                <th>Year</th>
                <th>Series</th>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        @else
          <table id="enrollmentDataTable" class="table table-hover">
            <thead>
              <tr>
                <th>Year</th>
                <th>Series</th>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        @else
          <table id="crimeDataTable" class="table table-hover">
            <thead>
              <tr>
                <th>Year</th>
                <th>Series</th>
