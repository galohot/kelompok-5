...
<div class="card my-4">
    <div class="card-header">
        <h3 class="m-auto card-title">General Data</h3>
    </div>
    <div class="card-body">
        <div class="datagrid">
            <div class="datagrid-item">
                <div class="datagrid-title">Latest Population Density</div>
                <div class="datagrid-content">{{ $latestPopulationDensity->Value }}</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Latest Surface Area</div>
                <div class="datagrid-content">{{ number_format($latestSurfaceArea->Value) }} thousand km²</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Latest GDP per capita</div>
                <div class="datagrid-content">${{ number_format($latestGdpPerCapitaValue) }}</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Income Category (According to the <a href="https://blogs.worldbank.org/opendata/new-world-bank-country-classifications-income-level-2022-2023"><strong>World Bank</strong></a>)</div>
                <div class="datagrid-content"><strong>{{ $incomeCategory }}</strong></div>
            </div>
            <!-- Add the following lines for the new data fields -->
            <div class="datagrid-item">
                <div class="datagrid-title">Urban Population</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Urban population'] ?? 'Null' }} sq.Km</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Tax Revenue</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Tax revenue (% of GDP)'] ?? 'Null' }} % of GDP</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Research and Development Expenditure</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Research and development expenditure (% of GDP)'] ?? 'Null' }} % of GDP</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Control of Corruption</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Control of Corruption: Estimate'] ?? 'Null' }} (Estimate)</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Current Health Expenditure</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Current health expenditure (% of GDP)'] ?? 'Null' }} % of GDP</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">CO2 Emissions</div>
                <div class="datagrid-content">{{ $worldBankMacroData['CO2 emissions (kg per 2015 US$ of GDP)'] ?? 'Null' }} kg per 2015 US$ of GDP</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Central Government Debt</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Central government debt, total (% of GDP)'] ?? 'Null' }} % of GDP</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Access to Electricity</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Access to electricity (% of population)'] ?? 'Null' }} % of Population</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Military Expenditure</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Military expenditure (% of GDP)'] ?? 'Null' }} % of GDP</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Population Growth (latest available data}</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Population growth (annual %)'] ?? 'Null' }} % Annualy</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Political Stability and Absence of Violence/Terrorism</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Political Stability and Absence of Violence/Terrorism: Estimate'] ?? 'Null' }} (Estimate)</div>
            </div>
            <div class="datagrid-item">
                <div class="datagrid-title">Human Capital Index</div>
                <div class="datagrid-content">{{ $worldBankMacroData['Human capital index (HCI) (scale 0-1)'] ?? 'Null' }}</div>
            </div>
        </div>
    </div>
</div>
